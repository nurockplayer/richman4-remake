...
Issue #197 restores the two ordinary source toolbar/hotkey entries as distinct
...
movement, AI, save/load/new-game and modal close boundaries. A canceled
target attempt cannot apply a queued old callback. Source close/reopen preserves the prior window quit policy. Native tests
