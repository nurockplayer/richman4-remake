...
**INCOMPLETE / native HOLD.** Initial integration stopped on a confirmed
balloon spawn defect: two successive rand1000 gates instead of one, plus
inverted occupied-lane y comparison. Native Game1x/2x130 checks had2 failures.
The contracts below are intended behavior, not final accepted fidelity.
Recovery requires a new admitted bounded repair and fresh validation/review.
...
It only decodes Panel78–111 and Data526, plus raw Panel81 input and Panel92
